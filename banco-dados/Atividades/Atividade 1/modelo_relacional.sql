...
INSERT INTO Empregado (MatEmp, NomEmp, EndEmp , CidEmp, Bairro, Cargo, CPF, Sexo, Comissao, Salario, SalarioBruto, CodDepto, CodSupervisor) 
VALUES (11, 'Maria Ramos', 'Rua Y', 'Belo Horizonte', 'Savassi', 'Presidente','55590333395', 'F', 10, 35000, 35000, 1, null);
INSERT INTO Empregado (MatEmp, NomEmp, EndEmp , CidEmp, Bairro, Cargo, CPF, Sexo, Comissao, Salario, SalarioBruto, CodDepto, CodSupervisor) 
VALUES (10, 'Marcos Ramos', 'Rua X', 'Itabira', 'Ita', 'Vendedor','55590333123', 'M', 10, 1000, 1000, 1, 11);
INSERT INTO Empregado (MatEmp, NomEmp, EndEmp , CidEmp, Bairro, Cargo, CPF,  Sexo, Comissao, Salario, SalarioBruto, CodDepto, CodSupervisor) 
VALUES (12, 'José Silva', 'Rua S', 'Belo Horizonte', 'Savassi', 'Vendedor', '55590333456', 'M', 10, 1000, 1000, 2, 11);
INSERT INTO Empregado (MatEmp, NomEmp, EndEmp , CidEmp, Bairro, Cargo, CPF, Sexo, Comissao, Salario, SalarioBruto, CodDepto, CodSupervisor) 
VALUES (13, 'Ana', 'Rua A', 'Belo Horizonte', 'Pampulha', 'Vendedor', '55590333789', 'F', 10, 1000, 1000, null, 11);
